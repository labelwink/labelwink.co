    ...
    <div className="space-y-5 max-w-[900px]">
      ...
      {form && (
        <div className="bg-white border border-[#e5e7eb] rounded-xl p-5 space-y-4">
          <h2 className="text-sm font-semibold text-[#1a1a1a]">{editId ? 'Edit Collection' : 'New Collection'}</h2>
          {formError && <p className="text-red-500 text-xs">{formError}</p>}

          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-medium text-[#1a1a1a] mb-1">Name *</label>
              <input
                value={form.name}
            ...
            <div>
              <label className="block text-xs font-medium text-[#1a1a1a] mb-1">Slug</label>
              <input
                value={form.slug}
            ...
            <div className="md:col-span-2">
              <label className="block text-xs font-medium text-[#1a1a1a] mb-1">Description</label>
              <textarea
            ...
            {/* Image upload */}
            <div className="md:col-span-2">
              <label className="block text-xs font-medium text-[#1a1a1a] mb-2">Cover Image</label>
            ...
            <div>
              <label className="block text-xs font-medium text-[#1a1a1a] mb-1">Sort Order</label>
              <input
                type="number" min="0"
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-xs text-[#1a1a1a] font-medium">Visible in store</span>
          </div>
      ...
      {loading ? (
        ...
        <div className="bg-white border border-dashed border-[#e5e7eb] rounded-xl p-16 text-center">
          <Layers size={28} className="mx-auto text-gray-200 mb-3" />
              ...
              {collections.map(c => (
                <tr key={c.id} className="hover:bg-[#f9fafb] transition-colors group">
                  ...
                  <td className="px-3 py-3.5 text-center">
                    <GripVertical size={13} className="text-gray-200 group-hover:text-gray-400 transition-colors mx-auto" />
                  </td>
                  {/* Image + name */}
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 rounded-lg overflow-hidden bg-gray-100 flex-shrink-0">
                        {c.image_url
                          ...
                          : <div className="w-full h-full flex items-center justify-center"><Layers size={14} className="text-gray-300" /></div>
                        }
                      </div>
                      <div>
                  ...
                  <td className="px-3 py-3.5 text-center hidden lg:table-cell">
                    <span className="text-xs font-semibold text-[#1a1a1a]">{productCount(c)}</span>
                  </td>
                  {/* Visible */}
                  <td className="px-3 py-3.5 text-center">
