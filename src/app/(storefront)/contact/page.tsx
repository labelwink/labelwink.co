...
export default async function ContactPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-12 max-w-5xl">
      ...
      <p className="text-[#9aab9e] mb-10">{subtitle}</p>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* Left: Contact details */}
        <div className="space-y-6">
          <h2 className="text-lg font-semibold text-[#ffffff]">Get In Touch</h2>
          ...
          {email && (
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold text-[#9aab9e] uppercase tracking-wide mb-1">Email</p>
          ...
          {whatsapp && (
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold text-[#9aab9e] uppercase tracking-wide mb-1">WhatsApp</p>
          ...
          {phone && (
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold text-[#9aab9e] uppercase tracking-wide mb-1">Phone</p>
          ...
          {address_line1 && (
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-xs font-semibold text-[#9aab9e] uppercase tracking-wide mb-1">Address</p>
          ...
          {hours && (
            <div className="mt-4 p-4 bg-[#f9f9f9] rounded-xl border border-[#e5e7eb]">
              <p className="text-xs font-semibold text-[#9aab9e] uppercase tracking-wide mb-1">Business Hours</p>
